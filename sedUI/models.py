...
class AboutPage(models.Model):
	...
	parkingLocation=models.CharField(max_length=5000)
	checkingLocation=models.CharField(max_length=5000)
...
class Register(models.Model):
	...
	register_type = models.CharField(max_length=10, choices=[("MITRE","MITRE"),("volunteer","volunteer"),("regular","regular")], blank=True)
