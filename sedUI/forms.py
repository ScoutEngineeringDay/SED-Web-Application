...
class RegistrationForm2(forms.Form):
	...
	email= forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Email', 'size': '40'}))
	email_confirm = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Email Confirmation', 'size': '40'}))
